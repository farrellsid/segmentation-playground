...
<!--
Opening line: "Every colour here is one neuron, segmented automatically, on one slice of a worm
nobody has hand-segmented."

Set expectations in one sentence: 10 to 15 minutes, a progress update, and the last slide is four
