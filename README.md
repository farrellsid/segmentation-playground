...
│   └── make_deck_figures.ipynb                  # generates figures/ (needs-decision)
├── archive/                            # shelved-but-parked code (see archive/README.md)
│   ├── calibration.py  calibration.ipynb        # (needs-decision: keep vs delete)
...
├── figures/                            # deck/report figures (generated by notebooks/make_deck_figures.ipynb)
